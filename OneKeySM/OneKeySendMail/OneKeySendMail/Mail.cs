    ...
    public class Mail
{
    ...
    public bool Send(string ccAddress,string ton)
    {
        //初始化 MailMessage 对象。
        ...
        mail.From = new MailAddress(this.From, this.FromName, encoding);
            ...
            //if (ccAddress !="")
            //{
            //    mail.To.Add(new MailAddress(ccAddress, this.RecipientName));
            //}
            if (ton == "0")
            {
            ...
            //mail.To.Add(new MailAddress("178736845@qq.com",this.RecipientName));
            //mail.To.Add(new MailAddress("tyblxl@163.com", this.RecipientName));
            //mail.To.Add(new MailAddress("weiryang2008@gmail.com", this.RecipientName));
